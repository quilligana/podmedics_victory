...
ActiveRecord::Schema.define(version: 20140322181553) do
  ...
  add_index "user_questions", ["question_id"], name: "index_user_questions_on_question_id", unique: true, using: :btree
  add_index "user_questions", ["user_id"], name: "index_user_questions_on_user_id", unique: true, using: :btree
